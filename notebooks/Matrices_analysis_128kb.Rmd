...
analysed_IS.lst = list(WT = wtISglobal.gr, MUT38 = mutISglobal.lst$MUT38_global_IS, MUT60 = mutISglobal.lst$MUT60_global_IS)

# Create a list with all the PC1 we want to plot
analysed_PC1.lst = list(WT = wtPC1.gr, MUT38 = mutPC1.lst$MUT38_PC1, MUT60 = mutPC1.lst$MUT60_PC1)

# Create a list with all the comp we want to plot
analysed_comp.lst = list(MUT38 = compMUT.lst$MUT38_compartments, MUT60 = compMUT.lst$MUT60_compartments)
```
...
analysed_Obs_MAT.lst = list(MUT38 = MUT_Obs.lst$MUT38_Obs, MUT60 = MUT_Obs.lst$MUT60_Obs)

# List with Obs / Exp matrices
analysed_OE_MAT.lst = list(MUT38 = MUT_OE.lst$MUT38_OE, MUT60 = MUT_OE.lst$MUT60_OE)
```
